...
> [!NOTE] <span style="color:blue">**Chinese (ZH & TW), Japanese, and Korean** languages have been added!</span>
> *Simply click the Load SD1.5 button, and the workflow will automatically load in your ComfyUI language.*
> *Compatible with [AIGODLIKE-ComfyUI-Translation](https://github.com/AIGODLIKE/AIGODLIKE-ComfyUI-Translation) node.*
...
**[👉 Follow Reezee AI on GitHub](https://github.com/NimaNzrii/reezee-ai)**
